...
#api_key = "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"  # Using directly instead of st.secrets
    ...
    if st.button("Get Feedback"):
        if (option == "Submit Audio for feedback" and audio_file is not None) or (option == "Speak in Real Time" and audio_bytes is not None):
            ...
            try:
                ...
                # Clean up the temporary audio feedback file
                os.unlink(audio_feedback)
